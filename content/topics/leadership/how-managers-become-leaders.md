...
![Diagram: a two-column from-to table with seven rows. Specialist to generalist. Analyst to integrator. Tactician to strategist. Bricklayer to architect. Problem solver to agenda setter. Warrior to diplomat. Supporting-cast member to lead role.](img/seven-shifts.png)
...
**Evidence check (2026 review, verdict: mixed).** Independent research backs the broad direction. A [2007 study of roughly 1,000 junior, mid-level, and senior managers](https://doi.org/10.1016/j.leaqua.2007.01.005) (Mumford, Campion, and Morgeson, *The Leadership Quarterly*) found that the mix of skills a job demands really does shift as you climb, with business and strategic skills weighing more heavily at the top, and the Center for Creative Leadership's 1980s derailment work (McCall and Lombardo, *Off the Track*, 1983) showed that the very strengths that earn a promotion can later become the liabilities that stall a career. But the specific "seven shifts" has never been tested or validated as a model, and the "specialist to generalist" shift is actively disputed: Amanda Goodall's studies of hospitals, universities, and sports teams (flagship: [physician-leaders and hospital performance, 2011, *Social Science & Medicine*](https://doi.org/10.1016/j.socscimed.2011.06.025)) find that leaders with deep domain expertise still outperform pure generalists even at the top. Treat it as a useful map, not a proven one, and note that the supporting studies are observational and correlational rather than causal. Bottom line: when you take a much bigger job, deliberately shift your time toward cross-functional and strategic work, but keep your deep expertise sharp, because the evidence says it still pays at the top.
