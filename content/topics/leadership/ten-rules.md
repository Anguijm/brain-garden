...
type: note
series: leadership
title: "Ten rules for leading and building teams (living list)"
status: curated
...
Two things to keep it honest. First, **every rule here is an Assessment**, a piece of
research or hard-won experience squeezed down into a slogan. A slogan always loses the
nuance, so treat each rule as a lens to test, not a law, and click the source link for the
full, caveated synopsis. That includes this sentence. Second, **the list is capped at
ten, on purpose.** The constraint is the point. As the library grows, a rule gets
sharpened, or bumped by a better one, or sent to the bench, but the list never just grows.
Every change is written down in the revision log at the bottom.
