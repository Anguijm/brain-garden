...
Recall from [the foundation chapter](01-what-is-an-llm) that models read and write in
...
[the context chapter](09-context-engineering) explains) can make the model lose track of
...
ones. And reasoning models (see [the reasoning chapter](03-reasoning-models)) are slower
...
- **Look things up instead of pasting everything.** Feeding in just the relevant facts
  (see [retrieval](10-retrieval-and-rag)) beats stuffing the whole window.
