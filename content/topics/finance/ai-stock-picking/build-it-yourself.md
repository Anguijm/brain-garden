...
[how the methods work](../ai-stock-picking) and [whether they beat the market](does-it-actually-work):
...
strength. If you have read the [basketball spread model](../../games/basketball-ats-model) notes,
...
- **[Building your own basketball spread model](../../games/basketball-ats-model)** — the same
