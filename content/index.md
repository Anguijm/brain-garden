...
- **[NewHome](projects/newhome/)**: remodeling a house in Japan, tracked from demo to
  move-in: the area-by-area [plan](projects/newhome/plan), a dated
  [decision log](projects/newhome/decisions), an [idea ledger](projects/newhome/ideas),
  and researched how-tos as the work throws up questions (flooring over tatami, shoji
  refresh, a 30-to-50-amp service upgrade).
...
- **[Top 10 games on every system Batocera can run](topics/games/batocera-top-games)**: the wish list: 277 games across 27 systems (Master System through Wii U), ranked by critical
...
- **[Console jailbreaks: which are worth your time](topics/technology/console-jailbreak-landscape)**: ranked survey of every modern platform: 3DS (do it today), unpatched Switch (best current-gen
...
- **[PS4 custom firmware: how the exploit chain works](topics/technology/ps4-cfw)**: the three-layer chain (WebKit → sandbox escape → kernel), generation-by-generation kernel
...
- **[How the PlayStation 3 got cracked permanently](topics/technology/playstation-hacks)**: Sony's cryptographic self-defeat: one constant in the wrong place, the root of trust burned
...
- **[Supplements for a midlife body: help, not hurt](topics/health/supplements-for-midlife/)**: an honest, evidence-based guide for a 48-year-old overweight man who's training: the short
...
- **[Muscle, aging, and "anabolic resistance"](topics/health/muscle-protein-synthesis-aging/)**: the real science behind a muscle-supplement pitch: how muscle stops responding to protein
...
- **[Mobile game engines you can drive from the CLI](topics/software/mobile-game-engines/)**: a survey of free, hobbyist-friendly engines for building Android and iOS games from the
...
- **[Plastic and tissue: 3D-printed flying model aircraft](topics/making/3d-printed-tissue-aircraft/)**: replacing balsa with X1C-printed LW-PLA frames and keeping the tissue: how printed
...
- **[Weighty board game pieces with cold-casting](topics/making/cold-cast-game-pieces/)**: the heavier mold-and-cast route off a Bambu X1C: metal-resin with steel/tungsten
  fill for real heft (companion to the electroplating piece).
- **[Metal-look board game pieces at scale](topics/making/plated-game-components/)**: 3D printing plus electroplating to give coins, tokens, and minis real metal heft,
...
- **[Navisworks Freedom 2026 — a complete course](topics/software/navisworks-freedom-2026/)**: using Autodesk's free 3D model viewer: opening published models, navigating,
...
- **[White's (dumpy) tree frogs](topics/pets/whites-tree-frog-bioactive-japan)**: care basics plus a bioactive terrarium build for Japan.
